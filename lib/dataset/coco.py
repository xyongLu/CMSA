...
class COCODataset(JointsDataset):
    ...
    def _load_coco_person_detection_results(self):
        ...
        print('=> Total boxes after fliter low score@{}: {}'.format(self.image_thre, num_boxes))
        return kpt_db
    ...
    def evaluate(self, cfg, preds, output_dir, all_boxes, img_path,
        ...
        res_file = os.path.join(
            res_folder, 'keypoints_{}_results_rank{}_{}.json'.format(
                self.image_set, cfg.RANK, cfg.UNI_NOTE)
        )
